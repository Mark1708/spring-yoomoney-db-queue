...
public class ProcessingSettingsParser {
    ...
    private static ProcessingMode parseProcessingMode(String name) {
        return switch (name) {
            case VALUE_PROCESSING_MODE_SEPARATE_TRANSACTIONS -> ProcessingMode.SEPARATE_TRANSACTIONS;
            case VALUE_PROCESSING_MODE_WRAP_IN_TRANSACTION -> ProcessingMode.WRAP_IN_TRANSACTION;
            case VALUE_PROCESSING_MODE_USE_EXTERNAL_EXECUTOR -> ProcessingMode.USE_EXTERNAL_EXECUTOR;
