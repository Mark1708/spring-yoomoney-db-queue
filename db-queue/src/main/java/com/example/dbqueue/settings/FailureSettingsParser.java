...
class FailureSettingsParser {
    ...
    private static FailRetryType parseRetryType(String name) {
        return switch (name) {
            case VALUE_TASK_RETRY_TYPE_GEOMETRIC -> FailRetryType.GEOMETRIC_BACKOFF;
            case VALUE_TASK_RETRY_TYPE_ARITHMETIC -> FailRetryType.ARITHMETIC_BACKOFF;
            case VALUE_TASK_RETRY_TYPE_LINEAR -> FailRetryType.LINEAR_BACKOFF;
